...
class V1beta1TrialSource(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["configMap", "trialSpec"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V1beta1TrialSource from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V1beta1TrialSource from a dict"""
        if obj is None:
            return None
