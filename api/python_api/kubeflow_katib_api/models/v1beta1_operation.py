...
class V1beta1Operation(BaseModel):
    """
    Operation contains type of operation in DAG
    """ # noqa: E501
    operation_type: Optional[StrictStr] = Field(default=None, alias="operationType")
    parameters: Optional[List[V1beta1ParameterSpec]] = None
    __properties: ClassVar[List[str]] = ["operationType", "parameters"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V1beta1Operation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V1beta1Operation from a dict"""
        if obj is None:
            return None
