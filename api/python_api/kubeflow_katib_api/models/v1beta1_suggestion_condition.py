...
class V1beta1SuggestionCondition(BaseModel):
    """
    ...
    type: StrictStr = Field(description="Type of Suggestion condition.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V1beta1SuggestionCondition from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V1beta1SuggestionCondition from a dict"""
        if obj is None:
            return None
