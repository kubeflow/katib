...
class V1beta1ExperimentCondition(BaseModel):
    """
    ...
    type: StrictStr = Field(description="Type of experiment condition.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V1beta1ExperimentCondition from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V1beta1ExperimentCondition from a dict"""
        if obj is None:
            return None
