...
class V1beta1TrialTemplate(object):
    ...
    def __init__(self, config_map=None, failure_condition=None, primary_pod_labels=None, retain=None, success_condition=None, trial_parameters=None, trial_spec=None):  # noqa: E501
