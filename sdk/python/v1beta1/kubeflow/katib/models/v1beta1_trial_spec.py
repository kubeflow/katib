...
class V1beta1TrialSpec(object):
    ...
    def __init__(self, failure_condition=None, metrics_collector=None, objective=None, parameter_assignments=None, primary_pod_labels=None, retain_run=None, run_spec=None, success_condition=None):  # noqa: E501
