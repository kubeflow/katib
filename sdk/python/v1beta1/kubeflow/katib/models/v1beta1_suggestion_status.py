...
class V1beta1SuggestionStatus(object):
    ...
    def __init__(self, algorithm_settings=None, completion_time=None, conditions=None, last_reconcile_time=None, start_time=None, suggestion_count=None, suggestions=None):  # noqa: E501
        """V1beta1SuggestionStatus - a model defined in Swagger"""  # noqa: E501
    ...
    def algorithm_settings(self):
        ...
        AlgorithmSettings defines HP or NAS algorithm settings which suggestion service returns. This can be empty if settings haven't been changed.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1beta1SuggestionStatus, dict):
