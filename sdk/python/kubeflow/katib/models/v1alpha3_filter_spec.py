...
class V1alpha3FilterSpec(object):
    ...
    def __init__(self, metrics_format=None):  # noqa: E501
        """V1alpha3FilterSpec - a model defined in Swagger"""  # noqa: E501
    ...
    def metrics_format(self):
        """Gets the metrics_format of this V1alpha3FilterSpec.  # noqa: E501
        ...
        :return: The metrics_format of this V1alpha3FilterSpec.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def metrics_format(self, metrics_format):
        """Sets the metrics_format of this V1alpha3FilterSpec.

        When the metrics output follows format as this field specified, metricsCollector collects it and reports to metrics server, it can be \"<metric_name>: <float>\" or else  # noqa: E501

        :param metrics_format: The metrics_format of this V1alpha3FilterSpec.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1alpha3FilterSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1alpha3FilterSpec):
            return False
