...
_TRIALSTATUS_TRIALCONDITIONTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='EARLYSTOPPED', index=5, number=5,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
...
_VALIDATEEARLYSTOPPINGSETTINGSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='early_stopping_spec', full_name='api.v1.beta1.ValidateEarlyStoppingSettingsRequest.early_stopping_spec', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_VALIDATEEARLYSTOPPINGSETTINGSREQUEST.fields_by_name['early_stopping_spec'].message_type = _EARLYSTOPPINGSPEC
