...
_GETSUGGESTIONSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='experiment_name', full_name='api.v1.alpha3.GetSuggestionsRequest.experiment_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='algorithm_name', full_name='api.v1.alpha3.GetSuggestionsRequest.algorithm_name', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_VALIDATEALGORITHMSETTINGSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='experiment_spec', full_name='api.v1.alpha3.ValidateAlgorithmSettingsRequest.experiment_spec', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='algorithm_name', full_name='api.v1.alpha3.ValidateAlgorithmSettingsRequest.algorithm_name', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MANAGER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='GetSuggestions',
    full_name='api.v1.alpha3.Manager.GetSuggestions',
    index=15,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='api.v1.alpha3.Manager.ValidateAlgorithmSettings',
    index=16,
    containing_service=None,
...
try:
  ...
  def beta_create_Manager_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
    ...
    request_deserializers = {
      ...
      ('api.v1.alpha3.Manager', 'GetSuggestions'): GetSuggestionsRequest.FromString,
      ...
      ('api.v1.alpha3.Manager', 'ValidateAlgorithmSettings'): ValidateAlgorithmSettingsRequest.FromString,
    }
    response_serializers = {
      ...
      ('api.v1.alpha3.Manager', 'GetSuggestions'): GetSuggestionsReply.SerializeToString,
      ...
      ('api.v1.alpha3.Manager', 'ValidateAlgorithmSettings'): ValidateAlgorithmSettingsReply.SerializeToString,
    }
    method_implementations = {
      ...
      ('api.v1.alpha3.Manager', 'GetSuggestions'): face_utilities.unary_unary_inline(servicer.GetSuggestions),
      ...
      ('api.v1.alpha3.Manager', 'ValidateAlgorithmSettings'): face_utilities.unary_unary_inline(servicer.ValidateAlgorithmSettings),
    }
  ...
  def beta_create_Manager_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
    ...
    request_serializers = {
      ...
      ('api.v1.alpha3.Manager', 'GetSuggestions'): GetSuggestionsRequest.SerializeToString,
      ...
      ('api.v1.alpha3.Manager', 'ValidateAlgorithmSettings'): ValidateAlgorithmSettingsRequest.SerializeToString,
    }
    response_deserializers = {
      ...
      ('api.v1.alpha3.Manager', 'GetSuggestions'): GetSuggestionsReply.FromString,
      ...
      ('api.v1.alpha3.Manager', 'ValidateAlgorithmSettings'): ValidateAlgorithmSettingsReply.FromString,
    }
    cardinalities = {
