...
_MANAGER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\0020*./api/Manager/DeleteObservationLog/{trial_name}')),
  ),
])
