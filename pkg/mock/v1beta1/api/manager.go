...
// Source: github.com/kubeflow/katib/pkg/apis/manager/v1beta1 (interfaces: ManagerClient)
...
func (m *MockManagerClient) DeleteObservationLog(arg0 context.Context, arg1 *v1beta1.DeleteObservationLogRequest, arg2 ...grpc.CallOption) (*v1beta1.DeleteObservationLogReply, error) {
	m.ctrl.T.Helper()
	...
	ret0, _ := ret[0].(*v1beta1.DeleteObservationLogReply)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockManagerClient) GetObservationLog(arg0 context.Context, arg1 *v1beta1.GetObservationLogRequest, arg2 ...grpc.CallOption) (*v1beta1.GetObservationLogReply, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*v1beta1.GetObservationLogReply)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockManagerClient) ReportObservationLog(arg0 context.Context, arg1 *v1beta1.ReportObservationLogRequest, arg2 ...grpc.CallOption) (*v1beta1.ReportObservationLogReply, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*v1beta1.ReportObservationLogReply)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
