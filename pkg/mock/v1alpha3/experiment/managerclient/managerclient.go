...
// Source: github.com/kubeflow/katib/pkg/controller.v1alpha3/experiment/managerclient (interfaces: ManagerClient)
...
func (m *MockManagerClient) CreateExperimentInDB(arg0 *v1alpha3.Experiment) error {
	m.ctrl.T.Helper()
...
func (m *MockManagerClient) DeleteExperimentInDB(arg0 *v1alpha3.Experiment) error {
	m.ctrl.T.Helper()
...
func (m *MockManagerClient) PreCheckRegisterExperimentInDB(arg0 *v1alpha3.Experiment) (*v1alpha30.PreCheckRegisterExperimentReply, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PreCheckRegisterExperimentInDB", arg0)
	ret0, _ := ret[0].(*v1alpha30.PreCheckRegisterExperimentReply)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockManagerClient) UpdateExperimentStatusInDB(arg0 *v1alpha3.Experiment) error {
	m.ctrl.T.Helper()
...
func (m *MockManagerClient) ValidateAlgorithmSettings(arg0 *v1alpha3.Experiment) (*v1alpha30.ValidateAlgorithmSettingsReply, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ValidateAlgorithmSettings", arg0)
	ret0, _ := ret[0].(*v1alpha30.ValidateAlgorithmSettingsReply)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
