...
import { NamespaceService, SnackBarService, TitleActionsToolbarModule, FormModule } from 'kubeflow';
  ...
  beforeEach(
    waitForAsync(() => {
      TestBed.configureTestingModule({
        ...
        providers: [
          { provide: ExperimentFormService, useValue: ExperimentFormServiceStub },
