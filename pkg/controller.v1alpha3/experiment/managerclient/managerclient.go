...
type ManagerClient interface {
	CreateExperimentInDB(instance *experimentsv1alpha3.Experiment) error
...
func (d *DefaultClient) CreateExperimentInDB(instance *experimentsv1alpha3.Experiment) error {
	experiment := getExperimentConf(instance)
	request := &api_pb.RegisterExperimentRequest{
		Experiment: experiment,
	}
	if _, err := commonv1alpha3.RegisterExperiment(request); err != nil {
		return err
	}
	if len(experiment.Spec.Algorithm.AlgorithmSetting) > 0 {
		...
		if _, err := commonv1alpha3.UpdateAlgorithmExtraSettings(req); err != nil {
			return err
		}
...
func (d *DefaultClient) DeleteExperimentInDB(instance *experimentsv1alpha3.Experiment) error {
	request := &api_pb.DeleteExperimentRequest{
		ExperimentName: instance.Name,
	}
	if _, err := commonv1alpha3.DeleteExperiment(request); err != nil {
		return err
	}
	return nil
}

func (d *DefaultClient) UpdateExperimentStatusInDB(instance *experimentsv1alpha3.Experiment) error {
	newStatus := &api_pb.ExperimentStatus{
		StartTime:      commonv1alpha3.ConvertTime2RFC3339(instance.Status.StartTime),
		CompletionTime: commonv1alpha3.ConvertTime2RFC3339(instance.Status.CompletionTime),
	...
	if _, err := commonv1alpha3.UpdateExperimentStatus(request); err != nil {
		return err
	}
	return nil
}

func (d *DefaultClient) PreCheckRegisterExperimentInDB(inst *experimentsv1alpha3.Experiment) (*api_pb.PreCheckRegisterExperimentReply, error) {
...
func getCondition(inst *experimentsv1alpha3.Experiment) api_pb.ExperimentStatus_ExperimentConditionType {
	condition, _ := inst.GetLastConditionType()
	switch condition {
	case experimentsv1alpha3.ExperimentCreated:
		return api_pb.ExperimentStatus_CREATED
	case experimentsv1alpha3.ExperimentRunning:
		return api_pb.ExperimentStatus_RUNNING
	case experimentsv1alpha3.ExperimentRestarting:
		return api_pb.ExperimentStatus_RESTARTING
	case experimentsv1alpha3.ExperimentSucceeded:
		return api_pb.ExperimentStatus_SUCCEEDED
	case experimentsv1alpha3.ExperimentFailed:
...
func getExperimentSpec(instance *experimentsv1alpha3.Experiment) *api_pb.ExperimentSpec {
	...
	if instance.Spec.Parameters != nil {
		...
		for _, p := range instance.Spec.Parameters {
			...
			case experimentsv1alpha3.ParameterTypeUnknown:
