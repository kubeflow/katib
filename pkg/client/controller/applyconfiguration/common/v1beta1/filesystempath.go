...
// FileSystemPathApplyConfiguration represents an declarative configuration of the FileSystemPath type for use
// with apply.
...
// FileSystemPathApplyConfiguration constructs an declarative configuration of the FileSystemPath type for use with
// apply.
func FileSystemPath() *FileSystemPathApplyConfiguration {
	return &FileSystemPathApplyConfiguration{}
}
