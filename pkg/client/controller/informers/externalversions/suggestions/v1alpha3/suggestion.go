...
import (
	...
	v1alpha3 "github.com/kubeflow/katib/pkg/client/controller/listers/suggestions/v1alpha3"
...
type SuggestionInformer interface {
	...
	Lister() v1alpha3.SuggestionLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SuggestionV1alpha3().Suggestions(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SuggestionV1alpha3().Suggestions(namespace).Watch(options)
			},
		},
...
func (f *suggestionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&suggestionsv1alpha3.Suggestion{}, f.defaultInformer)
}

func (f *suggestionInformer) Lister() v1alpha3.SuggestionLister {
	return v1alpha3.NewSuggestionLister(f.Informer().GetIndexer())
}
