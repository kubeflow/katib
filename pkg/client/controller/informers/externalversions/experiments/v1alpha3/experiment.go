...
import (
	...
	v1alpha3 "github.com/kubeflow/katib/pkg/client/controller/listers/experiments/v1alpha3"
...
type ExperimentInformer interface {
	...
	Lister() v1alpha3.ExperimentLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ExperimentV1alpha3().Experiments(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ExperimentV1alpha3().Experiments(namespace).Watch(options)
			},
		},
...
func (f *experimentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&experimentsv1alpha3.Experiment{}, f.defaultInformer)
}

func (f *experimentInformer) Lister() v1alpha3.ExperimentLister {
	return v1alpha3.NewExperimentLister(f.Informer().GetIndexer())
}
