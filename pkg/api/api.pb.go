...
type RegisterWorkerReauest struct {
	Worker *Worker `protobuf:"bytes,1,opt,name=worker" json:"worker,omitempty"`
}

func (m *RegisterWorkerReauest) Reset()                    { *m = RegisterWorkerReauest{} }
func (m *RegisterWorkerReauest) String() string            { return proto.CompactTextString(m) }
func (*RegisterWorkerReauest) ProtoMessage()               {}
func (*RegisterWorkerReauest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{26} }

func (m *RegisterWorkerReauest) GetWorker() *Worker {
	if m != nil {
		return m.Worker
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*RegisterWorkerReauest)(nil), "api.RegisterWorkerReauest")
...
type ManagerClient interface {
	...
	RegisterWorker(ctx context.Context, in *RegisterWorkerReauest, opts ...grpc.CallOption) (*RegisterWorkerReply, error)
...
func (c *managerClient) RegisterWorker(ctx context.Context, in *RegisterWorkerReauest, opts ...grpc.CallOption) (*RegisterWorkerReply, error) {
...
type ManagerServer interface {
	...
	RegisterWorker(context.Context, *RegisterWorkerReauest) (*RegisterWorkerReply, error)
...
func _Manager_RegisterWorker_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ManagerServer).RegisterWorker(ctx, req.(*RegisterWorkerReauest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var fileDescriptor0 = []byte{
	...
	,
}
