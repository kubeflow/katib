...
It has these top-level messages:
	...
	RunStudyReply
	StudyController
	GetStudyControllerRequest
	GetStudyControllerReply
	CreateTrialRequest
	CreateTrialReply
	GetTrialsRequest
	GetTrialsReply
...
type RunStudyRequest struct {
	StudyConfig                    *StudyConfig              `protobuf:"bytes,1,opt,name=study_config,json=studyConfig" json:"study_config,omitempty"`
	WorkerConfig                   *WorkerConfig             `protobuf:"bytes,2,opt,name=worker_config,json=workerConfig" json:"worker_config,omitempty"`
	DefaultSuggestionParameters    []*SuggestionParameter    `protobuf:"bytes,3,rep,name=default_suggestion_parameters,json=defaultSuggestionParameters" json:"default_suggestion_parameters,omitempty"`
	DefaultEarlyStoppingParameters []*EarlyStoppingParameter `protobuf:"bytes,4,rep,name=default_early_stopping_parameters,json=defaultEarlyStoppingParameters" json:"default_early_stopping_parameters,omitempty"`
	UpdateInterval                 int32                     `protobuf:"varint,5,opt,name=update_interval,json=updateInterval" json:"update_interval,omitempty"`
	MaxParallel                    int32                     `protobuf:"varint,6,opt,name=max_parallel,json=maxParallel" json:"max_parallel,omitempty"`
	RequestSuggestionNum           int32                     `protobuf:"varint,7,opt,name=request_suggestion_num,json=requestSuggestionNum" json:"request_suggestion_num,omitempty"`
	EarlystoppingInterval          int32                     `protobuf:"varint,8,opt,name=earlystopping_interval,json=earlystoppingInterval" json:"earlystopping_interval,omitempty"`
}

func (m *RunStudyRequest) Reset()                    { *m = RunStudyRequest{} }
func (m *RunStudyRequest) String() string            { return proto.CompactTextString(m) }
func (*RunStudyRequest) ProtoMessage()               {}
func (*RunStudyRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{23} }

func (m *RunStudyRequest) GetStudyConfig() *StudyConfig {
	if m != nil {
		return m.StudyConfig
	}
	return nil
...
func (m *RunStudyRequest) GetWorkerConfig() *WorkerConfig {
	if m != nil {
...
func (m *RunStudyRequest) GetDefaultSuggestionParameters() []*SuggestionParameter {
	if m != nil {
		return m.DefaultSuggestionParameters
	}
	return nil
}

func (m *RunStudyRequest) GetDefaultEarlyStoppingParameters() []*EarlyStoppingParameter {
	if m != nil {
		return m.DefaultEarlyStoppingParameters
	}
	return nil
}

func (m *RunStudyRequest) GetUpdateInterval() int32 {
	if m != nil {
...
func (m *RunStudyRequest) GetMaxParallel() int32 {
	if m != nil {
...
func (m *RunStudyRequest) GetRequestSuggestionNum() int32 {
	if m != nil {
		return m.RequestSuggestionNum
	}
	return 0
}

func (m *RunStudyRequest) GetEarlystoppingInterval() int32 {
	if m != nil {
		return m.EarlystoppingInterval
	}
	return 0
}

type RunStudyReply struct {
	StudyControllerId string `protobuf:"bytes,1,opt,name=study_controller_id,json=studyControllerId" json:"study_controller_id,omitempty"`
}

func (m *RunStudyReply) Reset()                    { *m = RunStudyReply{} }
func (m *RunStudyReply) String() string            { return proto.CompactTextString(m) }
func (*RunStudyReply) ProtoMessage()               {}
func (*RunStudyReply) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{24} }

func (m *RunStudyReply) GetStudyControllerId() string {
	if m != nil {
		return m.StudyControllerId
	}
	return ""
}
...
type StudyController struct {
	StudyControllerId      string        `protobuf:"bytes,1,opt,name=study_controller_id,json=studyControllerId" json:"study_controller_id,omitempty"`
	StudyId                string        `protobuf:"bytes,2,opt,name=study_id,json=studyId" json:"study_id,omitempty"`
	SuggestionAlgorithm    string        `protobuf:"bytes,3,opt,name=suggestion_algorithm,json=suggestionAlgorithm" json:"suggestion_algorithm,omitempty"`
	SuggestionParamId      string        `protobuf:"bytes,4,opt,name=suggestion_param_id,json=suggestionParamId" json:"suggestion_param_id,omitempty"`
	EarlystoppingAlgorithm string        `protobuf:"bytes,5,opt,name=earlystopping_algorithm,json=earlystoppingAlgorithm" json:"earlystopping_algorithm,omitempty"`
	EarlystoppingParamId   string        `protobuf:"bytes,6,opt,name=earlystopping_param_id,json=earlystoppingParamId" json:"earlystopping_param_id,omitempty"`
	UpdateInterval         int32         `protobuf:"varint,7,opt,name=update_interval,json=updateInterval" json:"update_interval,omitempty"`
	MaxParallel            int32         `protobuf:"varint,8,opt,name=max_parallel,json=maxParallel" json:"max_parallel,omitempty"`
	RequestSuggestionNum   int32         `protobuf:"varint,9,opt,name=request_suggestion_num,json=requestSuggestionNum" json:"request_suggestion_num,omitempty"`
	EarlystoppingInterval  int32         `protobuf:"varint,10,opt,name=earlystopping_interval,json=earlystoppingInterval" json:"earlystopping_interval,omitempty"`
	WorkerConfig           *WorkerConfig `protobuf:"bytes,11,opt,name=worker_config,json=workerConfig" json:"worker_config,omitempty"`
	Status                 State         `protobuf:"varint,12,opt,name=status,enum=api.State" json:"status,omitempty"`
	StatusMessage          string        `protobuf:"bytes,13,opt,name=status_message,json=statusMessage" json:"status_message,omitempty"`
}

func (m *StudyController) Reset()                    { *m = StudyController{} }
func (m *StudyController) String() string            { return proto.CompactTextString(m) }
func (*StudyController) ProtoMessage()               {}
func (*StudyController) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{25} }

func (m *StudyController) GetStudyControllerId() string {
	if m != nil {
		return m.StudyControllerId
	}
	return ""
...
func (m *StudyController) GetStudyId() string {
	if m != nil {
		return m.StudyId
	}
	return ""
...
func (m *StudyController) GetSuggestionAlgorithm() string {
	if m != nil {
...
func (m *StudyController) GetSuggestionParamId() string {
	if m != nil {
		return m.SuggestionParamId
	}
	return ""
}

func (m *StudyController) GetEarlystoppingAlgorithm() string {
	if m != nil {
...
func (m *StudyController) GetEarlystoppingParamId() string {
	if m != nil {
		return m.EarlystoppingParamId
	}
	return ""
}

func (m *StudyController) GetUpdateInterval() int32 {
	if m != nil {
		return m.UpdateInterval
	}
	return 0
...
func (m *StudyController) GetMaxParallel() int32 {
	if m != nil {
		return m.MaxParallel
	}
	return 0
...
func (m *StudyController) GetRequestSuggestionNum() int32 {
	if m != nil {
		return m.RequestSuggestionNum
	}
	return 0
...
func (m *StudyController) GetEarlystoppingInterval() int32 {
	if m != nil {
		return m.EarlystoppingInterval
	}
	return 0
...
func (m *StudyController) GetWorkerConfig() *WorkerConfig {
	if m != nil {
		return m.WorkerConfig
	}
	return nil
...
func (m *StudyController) GetStatus() State {
	if m != nil {
		return m.Status
	}
	return State_PENDING
...
func (m *StudyController) GetStatusMessage() string {
	if m != nil {
...
type GetStudyControllerRequest struct {
	StudyControllerId string `protobuf:"bytes,1,opt,name=study_controller_id,json=studyControllerId" json:"study_controller_id,omitempty"`
}

func (m *GetStudyControllerRequest) Reset()                    { *m = GetStudyControllerRequest{} }
func (m *GetStudyControllerRequest) String() string            { return proto.CompactTextString(m) }
func (*GetStudyControllerRequest) ProtoMessage()               {}
func (*GetStudyControllerRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{26} }

func (m *GetStudyControllerRequest) GetStudyControllerId() string {
	if m != nil {
		return m.StudyControllerId
	}
	return ""
...
type GetStudyControllerReply struct {
	StudyController *StudyController `protobuf:"bytes,1,opt,name=study_controller,json=studyController" json:"study_controller,omitempty"`
}

func (m *GetStudyControllerReply) Reset()                    { *m = GetStudyControllerReply{} }
func (m *GetStudyControllerReply) String() string            { return proto.CompactTextString(m) }
func (*GetStudyControllerReply) ProtoMessage()               {}
func (*GetStudyControllerReply) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{27} }

func (m *GetStudyControllerReply) GetStudyController() *StudyController {
	if m != nil {
		return m.StudyController
	}
	return nil
}
...
func (*CreateTrialRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{28} }
...
func (*CreateTrialReply) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{29} }
...
func (*GetTrialsRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{30} }
...
func (*GetTrialsReply) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{31} }
...
func (*RunTrialRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{32} }
...
func (*RunTrialReply) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{33} }
...
func (*StopWorkersRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{34} }
...
func (*StopWorkersReply) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{35} }
...
func (*GetWorkersRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{36} }
...
func (*GetWorkersReply) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{37} }
...
func (*GetSuggestionsRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{38} }
...
func (*GetSuggestionsReply) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{39} }
...
func (*GetShouldStopWorkersRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{40} }
...
func (*GetShouldStopWorkersReply) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{41} }
...
func (*GetMetricsRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{42} }
...
func (*GetMetricsReply) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{43} }
...
func (*ModelInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{44} }
...
func (*DataSetInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{45} }
...
func (*SaveStudyRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{46} }
...
func (*SaveStudyReply) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{47} }
...
func (*SaveModelRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{48} }
...
func (*SaveModelReply) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{49} }
...
func (*GetSavedStudiesRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{50} }
...
func (*GetSavedStudiesReply) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{51} }
...
func (*GetSavedModelsRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{52} }
...
func (*GetSavedModelsReply) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{53} }
...
func (*GetSavedModelRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{54} }
...
func (*GetSavedModelReply) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{55} }
...
func (*SetSuggestionParametersRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{56} }
...
func (*SetSuggestionParametersReply) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{57} }
...
func (*GetSuggestionParametersRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{58} }
...
func (*GetSuggestionParametersReply) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{59} }
...
func (*SuggestionParameterSet) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{61} }
...
func (*StopSuggestionRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{63} }
...
func (*StopSuggestionReply) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{64} }
...
func (*EarlyStoppingParameterSet) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{70} }
...
func init() {
	...
	proto.RegisterType((*RunStudyRequest)(nil), "api.RunStudyRequest")
	proto.RegisterType((*RunStudyReply)(nil), "api.RunStudyReply")
	proto.RegisterType((*StudyController)(nil), "api.StudyController")
	proto.RegisterType((*GetStudyControllerRequest)(nil), "api.GetStudyControllerRequest")
	proto.RegisterType((*GetStudyControllerReply)(nil), "api.GetStudyControllerReply")
...
type ManagerClient interface {
	...
	RunStudy(ctx context.Context, in *RunStudyRequest, opts ...grpc.CallOption) (*RunStudyReply, error)
	GetStudyController(ctx context.Context, in *GetStudyControllerRequest, opts ...grpc.CallOption) (*GetStudyControllerReply, error)
...
func (c *managerClient) RunStudy(ctx context.Context, in *RunStudyRequest, opts ...grpc.CallOption) (*RunStudyReply, error) {
	out := new(RunStudyReply)
	err := grpc.Invoke(ctx, "/api.Manager/RunStudy", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managerClient) GetStudyController(ctx context.Context, in *GetStudyControllerRequest, opts ...grpc.CallOption) (*GetStudyControllerReply, error) {
	out := new(GetStudyControllerReply)
	err := grpc.Invoke(ctx, "/api.Manager/GetStudyController", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ManagerServer interface {
	...
	RunStudy(context.Context, *RunStudyRequest) (*RunStudyReply, error)
	GetStudyController(context.Context, *GetStudyControllerRequest) (*GetStudyControllerReply, error)
...
func _Manager_RunStudy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RunStudyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ManagerServer).RunStudy(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.Manager/RunStudy",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ManagerServer).RunStudy(ctx, req.(*RunStudyRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Manager_GetStudyController_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetStudyControllerRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ManagerServer).GetStudyController(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.Manager/GetStudyController",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ManagerServer).GetStudyController(ctx, req.(*GetStudyControllerRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Manager_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RunStudy",
			Handler:    _Manager_RunStudy_Handler,
		},
		{
			MethodName: "GetStudyController",
			Handler:    _Manager_GetStudyController_Handler,
		},
		{
...
var fileDescriptor0 = []byte{
	...
	,
}
