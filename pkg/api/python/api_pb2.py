...
_FEASIBLESPACE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='scale', full_name='api.FeasibleSpace.scale', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='list', full_name='api.FeasibleSpace.list', index=3,
...
_FEASIBLESPACE.fields_by_name['scale'].enum_type = _SCALE
