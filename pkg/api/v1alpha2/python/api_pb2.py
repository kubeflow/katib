...
_EXPERIMENTSPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='nas_config', full_name='api.v1.alpha2.ExperimentSpec.nas_config', index=3,
