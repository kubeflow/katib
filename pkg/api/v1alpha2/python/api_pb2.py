...
_PRECHECKREGISTEREXPERIMENTREPLY = _descriptor.Descriptor(
  ...
  full_name='api.v1.alpha2.PreCheckRegisterExperimentReply',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='can_register', full_name='api.v1.alpha2.PreCheckRegisterExperimentReply.can_register', index=0,
...
_GETOBSERVATIONLOGREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='metric_name', full_name='api.v1.alpha2.GetObservationLogRequest.metric_name', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='start_time', full_name='api.v1.alpha2.GetObservationLogRequest.start_time', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='end_time', full_name='api.v1.alpha2.GetObservationLogRequest.end_time', index=3,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETSUGGESTIONSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='experiment', full_name='api.v1.alpha2.GetSuggestionsRequest.experiment', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='trials', full_name='api.v1.alpha2.GetSuggestionsRequest.trials', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETSUGGESTIONSREPLY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='algorithm', full_name='api.v1.alpha2.GetSuggestionsReply.algorithm', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
PreCheckRegisterExperimentReply = _reflection.GeneratedProtocolMessageType('PreCheckRegisterExperimentReply', (_message.Message,), dict(
  ...
  __module__ = 'api_pb2'
  # @@protoc_insertion_point(class_scope:api.v1.alpha2.PreCheckRegisterExperimentReply)
  ))
...
_MANAGER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='api.v1.alpha2.Manager.PreCheckRegisterExperiment',
    index=1,
    containing_service=None,
    input_type=_REGISTEREXPERIMENTREQUEST,
...
try:
  ...
  def beta_create_Manager_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
    ...
    request_deserializers = {
      ...
      ('api.v1.alpha2.Manager', 'PreCheckRegisterExperiment'): RegisterExperimentRequest.FromString,
    ...
    response_serializers = {
      ...
      ('api.v1.alpha2.Manager', 'PreCheckRegisterExperiment'): PreCheckRegisterExperimentReply.SerializeToString,
    ...
    method_implementations = {
      ...
      ('api.v1.alpha2.Manager', 'PreCheckRegisterExperiment'): face_utilities.unary_unary_inline(servicer.PreCheckRegisterExperiment),
  ...
  def beta_create_Manager_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
    ...
    request_serializers = {
      ...
      ('api.v1.alpha2.Manager', 'PreCheckRegisterExperiment'): RegisterExperimentRequest.SerializeToString,
    ...
    response_deserializers = {
      ...
      ('api.v1.alpha2.Manager', 'PreCheckRegisterExperiment'): PreCheckRegisterExperimentReply.FromString,
