...
_HEALTHCHECKRESPONSE_SERVINGSTATUS = _descriptor.EnumDescriptor(
  name='ServingStatus',
  full_name='grpc.health.v2.HealthCheckResponse.ServingStatus',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_HEALTHCHECKREQUEST = _descriptor.Descriptor(
  ...
  full_name='grpc.health.v2.HealthCheckRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='service', full_name='grpc.health.v2.HealthCheckRequest.service', index=0,
...
_HEALTHCHECKRESPONSE = _descriptor.Descriptor(
  ...
  full_name='grpc.health.v2.HealthCheckResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='status', full_name='grpc.health.v2.HealthCheckResponse.status', index=0,
...
HealthCheckRequest = _reflection.GeneratedProtocolMessageType('HealthCheckRequest', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:grpc.health.v2.HealthCheckRequest)
  ))
...
HealthCheckResponse = _reflection.GeneratedProtocolMessageType('HealthCheckResponse', (_message.Message,), dict(
  ...
  __module__ = 'health.health_pb2'
  # @@protoc_insertion_point(class_scope:grpc.health.v2.HealthCheckResponse)
  ))
...
_HEALTH = _descriptor.ServiceDescriptor(
  name='Health',
  full_name='grpc.health.v2.Health',
  file=DESCRIPTOR,
  index=0,
  options=None,
  ...
  _descriptor.MethodDescriptor(
    name='Check',
    full_name='grpc.health.v2.Health.Check',
    index=0,
...
try:
  ...
  def add_HealthServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
        'grpc.health.v2.Health', rpc_method_handlers)
  ...
  def beta_create_Health_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
    ...
    request_deserializers = {
      ('grpc.health.v2.Health', 'Check'): HealthCheckRequest.FromString,
    }
    response_serializers = {
      ('grpc.health.v2.Health', 'Check'): HealthCheckResponse.SerializeToString,
    }
    method_implementations = {
      ('grpc.health.v2.Health', 'Check'): face_utilities.unary_unary_inline(servicer.Check),
    }
  ...
  def beta_create_Health_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
    ...
    generated only to ease transition from grpcio<0.15.0 to grpcio>=0.15.0"""
    request_serializers = {
      ('grpc.health.v2.Health', 'Check'): HealthCheckRequest.SerializeToString,
    }
    response_deserializers = {
      ('grpc.health.v2.Health', 'Check'): HealthCheckResponse.FromString,
    }
    cardinalities = {
