...
You can visualize general trend of Hyper parameter space and each training history. The following example UI
is generated by [random-example](https://github.com/kubeflow/katib/blob/master/examples/random-example.yaml).
