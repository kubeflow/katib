{
  ...
  components: {
    ...
    "workflows-v1alpha3": {
      ...
      name: "some-very-very-very-very-very-long-name-katib-v1alpha3-presubmit-test-374-6e32",
      namespace: "kubeflow-test-infra",
      registry: "gcr.io/kubbeflow-ci",
      prow_env: "JOB_NAME=katib-v1alpha3-presubmit-test,JOB_TYPE=presubmit,PULL_NUMBER=374,REPO_NAME=k8s,REPO_OWNER=tensorflow,BUILD_NUMBER=6e32",
      versionTag: null,
    },
    "workflows-v1beta1": {
      bucket: "kubeflow-ci_temp",
