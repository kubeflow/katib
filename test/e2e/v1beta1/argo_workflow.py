...
KATIB_IMAGES = {
    ...
    "trial-mxnet-mnist":            "examples/v1beta1/trial-training-containers/mxnet-mnist/Dockerfile",
    "trial-pytorch-mnist":          "examples/v1beta1/trial-training-containers/pytorch-mnist/Dockerfile",
