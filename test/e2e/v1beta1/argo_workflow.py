...
KATIB_IMAGES = {
    ...
    "trial-mxnet-mnist":            "examples/v1beta1/mxnet-mnist/Dockerfile",
    "trial-pytorch-mnist":          "examples/v1beta1/pytorch-mnist/Dockerfile",
...
# Key - image name, Value - dockerfile location.
KATIB_EXPERIMENTS = {
    "random":                   "examples/v1beta1/random-example.yaml",
    "grid":                     "examples/v1beta1/grid-example.yaml",
    "bayesianoptimization":     "examples/v1beta1/bayesianoptimization-example.yaml",
    "tpe":                      "examples/v1beta1/tpe-example.yaml",
    "multivariate-tpe":         "examples/v1beta1/multivariate-tpe-example.yaml",
    "cmaes":                    "examples/v1beta1/cmaes-example.yaml",
