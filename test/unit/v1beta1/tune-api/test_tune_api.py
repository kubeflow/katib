...
from kubeflow.katib import KatibClient, models, types
...
class TestTuneAPI(TestCase):
    ...
    # Case 1: Custom objective - distributed
    @patch("kubeflow.katib.KatibClient.create_experiment")
    def test_experiment_creation_with_custom_objective_distributed(
    ...
    # Case 2: Custom objective - non-distributed
    @patch("kubeflow.katib.KatibClient.create_experiment")
    def test_experiment_creation_with_custom_objective_non_distributed(
        self, mock_create_experiment
    ):
        self.katib_client.tune(
            name="experiment",
    ...
    # Case 3: External models and datasets - distributed
    @patch("kubeflow.katib.KatibClient.create_experiment")
    def test_experiment_creation_with_external_distributed(
        self, mock_create_experiment
    ):
        exp_name = "experiment"
        self.katib_client.tune(
    ...
    # Case 4: External models and datasets - non-distributed
    @patch("kubeflow.katib.KatibClient.create_experiment")
    def test_experiment_creation_with_external_non_distributed(
        self, mock_create_experiment
    ):
        exp_name = "experiment"
        self.katib_client.tune(
        ...
        self.assertEqual(experiment.spec.parameters, expected_parameters)
        self.assertEqual(
            experiment.spec.trial_template.trial_spec.spec.template.spec.init_containers,
            expected_init_container,
        )
        self.assertEqual(
            experiment.spec.trial_template.trial_spec.spec.template.spec.containers,
