...
cp cmd/suggestion/chocolate/v1beta1/Dockerfile .
gcloud builds submit . --tag=${REGISTRY}/${REPO_NAME}/v1beta1/suggestion-chocolate:${VERSION} --project=${PROJECT}
gcloud container images add-tag --quiet ${REGISTRY}/${REPO_NAME}/v1beta1/suggestion-chocolate:${VERSION} ${REGISTRY}/${REPO_NAME}/v1beta1/suggestion-chocolate:latest --verbosity=info
