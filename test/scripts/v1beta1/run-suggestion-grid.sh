...
sed -i -e "s@/opt/mxnet-mnist/mnist.py@/opt/mxnet-mnist/mnist.py --num-epochs=2@" ../../../examples/v1beta1/grid-example.yaml

echo "Running e2e chocolate grid experiment"
export KUBECONFIG=$HOME/.kube/config
./run-e2e-experiment ../../../examples/v1beta1/grid-example.yaml
