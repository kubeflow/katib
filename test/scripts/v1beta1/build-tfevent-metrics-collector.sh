...
GO_DIR=${GOPATH}/src/github.com/${REPO_OWNER}/${REPO_NAME}-tfevent-metrics-collector
...
cp cmd/metricscollector/v1beta1/tfevent-metricscollector/Dockerfile .
gcloud builds submit . --tag=${REGISTRY}/${REPO_NAME}/v1beta1/tfevent-metrics-collector:${VERSION} --project=${PROJECT}
gcloud container images add-tag --quiet ${REGISTRY}/${REPO_NAME}/v1beta1/tfevent-metrics-collector:${VERSION} ${REGISTRY}/${REPO_NAME}/v1beta1/tfevent-metrics-collector:latest --verbosity=info
