...
sed -i -e "s@/opt/mxnet-mnist/mnist.py@/opt/mxnet-mnist/mnist.py --num-epochs=2@" ../../../examples/v1beta1/hyperband-example.yaml

echo "Running e2e hyperband experiment"
export KUBECONFIG=$HOME/.kube/config
./run-e2e-experiment ../../../examples/v1beta1/hyperband-example.yaml
