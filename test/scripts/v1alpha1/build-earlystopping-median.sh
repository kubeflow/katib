...
gcloud container images add-tag --quiet ${REGISTRY}/${REPO_NAME}/v1alpha1/earlystopping-medianstopping:${VERSION} ${REGISTRY}/${REPO_NAME}/v1alpha1/earlystopping-medianstopping:latest --verbosity=info
