...
PROJECT="${GCP_PROJECT}"
GO_DIR=${GOPATH}/src/github.com/${REPO_OWNER}/${REPO_NAME}-manager-rest
...
gcloud container images add-tag --quiet ${REGISTRY}/${REPO_NAME}/v1alpha2/katib-manager-rest:${VERSION} ${REGISTRY}/${REPO_NAME}/v1alpha2/katib-manager-rest:latest --verbosity=info
