...
gcloud container images add-tag --quiet ${REGISTRY}/${REPO_NAME}/v1alpha2/katib-controller:${VERSION} ${REGISTRY}/${REPO_NAME}/v1alpha2/katib-controller:latest --verbosity=info
