...
sed -i -e "s/image: katib\/suggestion-bayesianoptimization/image: ${REGISTRY}\/${REPO_NAME}\/suggestion-bayesianoptimization:${VERSION}/" manifests/suggestion/bayesianoptimization/deployment.yaml
