...
cp cmd/suggestion/hyperband/v1alpha3/Dockerfile .
gcloud builds submit . --tag=${REGISTRY}/${REPO_NAME}/v1alpha3/suggestion-hyperband:${VERSION} --project=${PROJECT}
gcloud container images add-tag --quiet ${REGISTRY}/${REPO_NAME}/v1alpha3/suggestion-hyperband:${VERSION} ${REGISTRY}/${REPO_NAME}/v1alpha3/suggestion-hyperband:latest --verbosity=info
