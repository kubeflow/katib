...
docker build -t ${REGISTRY}/mxnet-mnist:${TAG} -f examples/${VERSION}/trial-training-containers/mxnet-mnist/Dockerfile .

echo -e "\nBuilding PyTorch mnist training container example...\n"
docker build -t ${REGISTRY}/pytorch-mnist:${TAG} -f examples/${VERSION}/trial-training-containers/pytorch-mnist/Dockerfile .
