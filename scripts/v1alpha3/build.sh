...
docker build -t ${REGISTRY}/${PREFIX}/v1alpha3/sidecar-metrics-collector -f ${CMD_PREFIX}/sidecar-metricscollector/v1alpha3/Dockerfile .

echo "Building TF Event metrics collector image..."
docker build -t ${REGISTRY}/${PREFIX}/v1alpha3/tfevent-metrics-collector -f ${CMD_PREFIX}/tfevent-metricscollector/v1alpha3/Dockerfile .
