...
- Automated cherry pick of #1808: Fix default label for Training Operators on release-0.13 ([#1813](https://github.com/kubeflow/katib/pull/1813) by [@andreyvelich](https://github.com/andreyvelich))
- [cherry-pick] Update supported Python version for kubeflow-katib SDK ([#1798](https://github.com/kubeflow/katib/pull/1798) by [@tenzen-y](https://github.com/tenzen-y))
- Add CPU architecture to release scripts ([#1791](https://github.com/kubeflow/katib/pull/1791) by [@andreyvelich](https://github.com/andreyvelich))
- Bump nanoid from 3.1.28 to 3.2.0 in /pkg/new-ui/v1beta1/frontend ([#1788](https://github.com/kubeflow/katib/pull/1788) by [@dependabot[bot]](https://github.com/apps/dependabot))
- Bump log4js from 6.3.0 to 6.4.0 in /pkg/new-ui/v1beta1/frontend ([#1787](https://github.com/kubeflow/katib/pull/1787) by [@dependabot[bot]](https://github.com/apps/dependabot))
...
- Bump grpc_health_probe version to v0.4.6 ([#1781](https://github.com/kubeflow/katib/pull/1781) by [@tenzen-y](https://github.com/tenzen-y))
- Bump shelljs from 0.8.4 to 0.8.5 in /pkg/new-ui/v1beta1/frontend ([#1780](https://github.com/kubeflow/katib/pull/1780) by [@dependabot[bot]](https://github.com/apps/dependabot))
- Bump engine.io from 4.1.1 to 4.1.2 in /pkg/new-ui/v1beta1/frontend ([#1777](https://github.com/kubeflow/katib/pull/1777) by [@dependabot[bot]](https://github.com/apps/dependabot))
- Bump `alpine` version to 3.15 ([#1779](https://github.com/kubeflow/katib/pull/1779) by [@tenzen-y](https://github.com/tenzen-y))
- Bump follow-redirects from 1.5.10 to 1.14.7 in /pkg/ui/v1beta1/frontend ([#1773](https://github.com/kubeflow/katib/pull/1773) by [@dependabot[bot]](https://github.com/apps/dependabot))
- Bump tar from 6.1.5 to 6.1.11 in /pkg/new-ui/v1beta1/frontend ([#1772](https://github.com/kubeflow/katib/pull/1772) by [@dependabot[bot]](https://github.com/apps/dependabot))
- Bump follow-redirects from 1.13.0 to 1.14.7 in /pkg/new-ui/v1beta1/frontend ([#1771](https://github.com/kubeflow/katib/pull/1771) by [@dependabot[bot]](https://github.com/apps/dependabot))
- [new-ui] Bump angular version to 12 ([#1712](https://github.com/kubeflow/katib/pull/1712) by [@seong7](https://github.com/seong7))
- Bump lodash from 4.17.15 to 4.17.21 in /pkg/ui/v1beta1/frontend ([#1770](https://github.com/kubeflow/katib/pull/1770) by [@dependabot[bot]](https://github.com/apps/dependabot))
- Bump path-parse from 1.0.6 to 1.0.7 in /pkg/ui/v1beta1/frontend ([#1760](https://github.com/kubeflow/katib/pull/1760) by [@dependabot[bot]](https://github.com/apps/dependabot))
- Bump ws from 5.2.2 to 5.2.3 in /pkg/ui/v1beta1/frontend ([#1761](https://github.com/kubeflow/katib/pull/1761) by [@dependabot[bot]](https://github.com/apps/dependabot))
- Bump tmpl from 1.0.4 to 1.0.5 in /pkg/ui/v1beta1/frontend ([#1762](https://github.com/kubeflow/katib/pull/1762) by [@dependabot[bot]](https://github.com/apps/dependabot))
- manifests: Upgrade cert-manager API from v1alpha2 to v1 ([#1752](https://github.com/kubeflow/katib/pull/1752) by [@haoxins](https://github.com/haoxins))
...
- katib/operators: removes unrecognized keys from metadata.yaml ([#1759](https://github.com/kubeflow/katib/pull/1759) by [@DnPlas](https://github.com/DnPlas))
...
- Enhance/UI feasible space ([#1721](https://github.com/kubeflow/katib/pull/1721) by [@seong7](https://github.com/seong7))
- [Bug Fix - new ui] : Fix bug on list type hp ([#1704](https://github.com/kubeflow/katib/pull/1704) by [@seong7](https://github.com/seong7))
- docs: Add my presentations that include Katib ([#1753](https://github.com/kubeflow/katib/pull/1753) by [@terrytangyuan](https://github.com/terrytangyuan))
- Update links for issue template ([#1751](https://github.com/kubeflow/katib/pull/1751) by [@andreyvelich](https://github.com/andreyvelich))
...
- docs: Argo -> Argo Workflows ([#1741](https://github.com/kubeflow/katib/pull/1741) by [@terrytangyuan](https://github.com/terrytangyuan))
...
- Fix Range for Int and Double values in Grid ([#1732](https://github.com/kubeflow/katib/pull/1732) by [@andreyvelich](https://github.com/andreyvelich))
- fix: check if parameter references exist in experiment parameters ([#1726](https://github.com/kubeflow/katib/pull/1726) by [@henrysecond1](https://github.com/henrysecond1))
...
- fix: close mysql statement and rows resources when sql exec end ([#1720](https://github.com/kubeflow/katib/pull/1720) by [@chenwenjun-github](https://github.com/chenwenjun-github))
...
- Run Early Stopping Pipeline Example ([#1727](https://github.com/kubeflow/katib/pull/1727) by [@andreyvelich](https://github.com/andreyvelich))
- Fix clusterrole of katib-controller to access image pull secrets ([#1725](https://github.com/kubeflow/katib/pull/1725) by [@henrysecond1](https://github.com/henrysecond1))
...
- Update Algorithm Service Doc for new CI script ([#1724](https://github.com/kubeflow/katib/pull/1724) by [@andreyvelich](https://github.com/andreyvelich))
...
- #1714: Missing metrics port annotation ([#1715](https://github.com/kubeflow/katib/pull/1715) by [@alexeykaplin](https://github.com/alexeykaplin))
- Update OWNERS for charm operators ([#1718](https://github.com/kubeflow/katib/pull/1718) by [@ca-scribner](https://github.com/ca-scribner))
- Add Kubeflow Pipelines Examples ([#1632](https://github.com/kubeflow/katib/pull/1632) by [@andreyvelich](https://github.com/andreyvelich))
- Fix path to the NAS Trial images ([#1711](https://github.com/kubeflow/katib/pull/1711) by [@andreyvelich](https://github.com/andreyvelich))
- [enhance] change default metrics collect format ([#1707](https://github.com/kubeflow/katib/pull/1707) by [@anencore94](https://github.com/anencore94))
- Implement some unit tests for the katibconfig package ([#1690](https://github.com/kubeflow/katib/pull/1690) by [@tenzen-y](https://github.com/tenzen-y))
- Fix hyperlink for build status ([#1703](https://github.com/kubeflow/katib/pull/1703) by [@tenzen-y](https://github.com/tenzen-y))
- Modify SDK examples for Katib 0.12 release ([#1631](https://github.com/kubeflow/katib/pull/1631) by [@andreyvelich](https://github.com/andreyvelich))
...
- Add Changelog for Katib 0.12.0 release ([#1695](https://github.com/kubeflow/katib/pull/1695) by [@andreyvelich](https://github.com/andreyvelich))
- Bump Katib Python SDK to 0.12.0 version ([#1694](https://github.com/kubeflow/katib/pull/1694) by [@andreyvelich](https://github.com/andreyvelich))
...
- Add Python test requirements file ([#1684](https://github.com/kubeflow/katib/pull/1684) by [@andreyvelich](https://github.com/andreyvelich))
...
- Add OWNERS file for the new ui ([#1681](https://github.com/kubeflow/katib/pull/1681) by [@kimwnasptd](https://github.com/kimwnasptd))
- Add envtest to check `reconcileRBAC` ([#1678](https://github.com/kubeflow/katib/pull/1678) by [@tenzen-y](https://github.com/tenzen-y))
- [bugfix]: absolute value and typo ([#1676](https://github.com/kubeflow/katib/pull/1676) by [@anencore94](https://github.com/anencore94))
...
- Bump axios from 0.18.1 to 0.21.2 in /pkg/ui/v1beta1/frontend ([#1665](https://github.com/kubeflow/katib/pull/1665) by [@dependabot[bot]](https://github.com/apps/dependabot))
- Bump Katib Python SDK to 0.12.0rc1 version ([#1660](https://github.com/kubeflow/katib/pull/1660) by [@andreyvelich](https://github.com/andreyvelich))
- Add Cert Generator to prow include dirs ([#1669](https://github.com/kubeflow/katib/pull/1669) by [@andreyvelich](https://github.com/andreyvelich))
...
- Add Changelog for Katib 0.12.0-rc.1 release ([#1661](https://github.com/kubeflow/katib/pull/1661) by [@andreyvelich](https://github.com/andreyvelich))
- Add mockgen version to gen script ([#1658](https://github.com/kubeflow/katib/pull/1658) by [@andreyvelich](https://github.com/andreyvelich))
- Remove README toc script ([#1659](https://github.com/kubeflow/katib/pull/1659) by [@andreyvelich](https://github.com/andreyvelich))
- [bugfix]: increase test timeout ([#1654](https://github.com/kubeflow/katib/pull/1654) by [@anencore94](https://github.com/anencore94))
- UI: Handle missing TrialTemplates ([#1652](https://github.com/kubeflow/katib/pull/1652) by [@kimwnasptd](https://github.com/kimwnasptd))
- Bump tar from 4.4.15 to 4.4.19 in /pkg/new-ui/v1beta1/frontend ([#1650](https://github.com/kubeflow/katib/pull/1650) by [@dependabot[bot]](https://github.com/apps/dependabot))
- Update Changelog for Katib 0.12.0-rc.0 release ([#1642](https://github.com/kubeflow/katib/pull/1642) by [@andreyvelich](https://github.com/andreyvelich))
...
- Bump Katib Python SDK to 0.12.0rc0 version ([#1640](https://github.com/kubeflow/katib/pull/1640) by [@andreyvelich](https://github.com/andreyvelich))
...
- new-ui: Add devDependency - prettier ([#1629](https://github.com/kubeflow/katib/pull/1629) by [@seong7](https://github.com/seong7))
...
- Adding tests in multiple steps ([#1634](https://github.com/kubeflow/katib/pull/1634) by [@johnugeorge](https://github.com/johnugeorge))
