...
var (
	controllerKind = v1beta1.SchemeGroupVersionKind
)

func NewBasePod(name string, job *v1beta1.PyTorchJob, t *testing.T) *v1.Pod {
	return &v1.Pod{
...
func NewPod(job *v1beta1.PyTorchJob, typ string, index int, t *testing.T) *v1.Pod {
...
func NewPodList(count int32, status v1.PodPhase, job *v1beta1.PyTorchJob, typ string, start int32, t *testing.T) []*v1.Pod {
	pods := []*v1.Pod{}
...
func SetPodsStatuses(podIndexer cache.Indexer, job *v1beta1.PyTorchJob, typ string, pendingPods, activePods, succeededPods, failedPods int32, t *testing.T) {
	var index int32
