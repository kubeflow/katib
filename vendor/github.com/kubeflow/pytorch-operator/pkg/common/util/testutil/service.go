...
func NewBaseService(name string, job *v1beta1.PyTorchJob, t *testing.T) *v1.Service {
	return &v1.Service{
...
func NewService(job *v1beta1.PyTorchJob, typ string, index int, t *testing.T) *v1.Service {
...
func NewServiceList(count int32, job *v1beta1.PyTorchJob, typ string, t *testing.T) []*v1.Service {
	services := []*v1.Service{}
...
func SetServices(serviceIndexer cache.Indexer, job *v1beta1.PyTorchJob, typ string, activeWorkerServices int32, t *testing.T) {
