...
import (
	...
	v1alpha2 "github.com/kubeflow/pytorch-operator/pkg/client/listers/kubeflow/v1alpha2"
...
func (f *pyTorchJobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&pytorchv1alpha2.PyTorchJob{}, defaultPyTorchJobInformer)
}
