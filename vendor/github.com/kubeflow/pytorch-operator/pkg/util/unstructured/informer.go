...
import (
	...
	informer "github.com/kubeflow/pytorch-operator/pkg/client/informers/externalversions/kubeflow/v1alpha2"
	lister "github.com/kubeflow/pytorch-operator/pkg/client/listers/kubeflow/v1alpha2"
)
...
func NewPyTorchJobInformer(resource *metav1.APIResource, client dynamic.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) informer.PyTorchJobInformer {
